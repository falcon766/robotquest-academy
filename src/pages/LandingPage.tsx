        ...
        <div className="min-h-screen bg-[#0a0a0a] text-slate-200 overflow-hidden relative font-sans selection:bg-blue-500/30">
            ...
            <nav className="container mx-auto px-6 py-6 flex justify-between items-center relative z-10">
                <div className="text-xl font-bold tracking-tight flex items-center gap-3">
                    ...
                    <span className="text-slate-100">
                        Droid<span className="text-blue-500">Academy</span>
                    </span>
                </div>
                <div className="flex gap-4">
                    <Link to="/login" className="px-4 py-2 text-slate-400 hover:text-white transition-colors text-sm font-medium">Login</Link>
                    <Link to="/login" className="px-5 py-2 bg-white text-slate-950 text-sm font-bold rounded hover:bg-slate-200 transition-all">
                        Get Started
                    </Link>
                </div>
            </nav>
            ...
            <main className="container mx-auto px-6 pt-24 pb-32 text-center relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-24">
                    <Link to="/login" className="px-8 py-4 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-500 transition-all flex items-center gap-2 group shadow-lg shadow-blue-900/20">
                        Start Learning Free
